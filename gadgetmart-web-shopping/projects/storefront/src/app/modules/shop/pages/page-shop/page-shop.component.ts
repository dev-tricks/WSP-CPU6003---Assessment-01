...
import { products } from 'projects/storefront/src/fake-server/database/products';
...
export class PageShopComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.route.data.pipe(
            ...
            let newItemList = [];
            this.page.findAllProduct().subscribe((data) => {
                data.forEach(element => {
                    newItemList.push({
                        ...
                        "slug": element.id,
                        "sku": element.source + '-' + element.id,
                        "partNumber": element.id,
                        "stock": "in-stock",
                        "price": element.price,
                        "compareAtPrice": null,
                        "images": [
