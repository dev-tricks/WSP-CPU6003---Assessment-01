    ...
    private checkout(): void {
        ...
        this.cart.items.forEach(element => {
            orderDetail.push({
                ...
                "category" : element.product.description,
        ...
        this.cart.createOrder(orderObject).subscribe((data) => {
            console.log("🚀 ~ file: page-checkout.component.ts ~ line 215 ~ PageCheckoutComponent ~ this.cart.createOrder ~ data", data)
